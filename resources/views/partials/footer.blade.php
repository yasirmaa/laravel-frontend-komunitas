...
<footer id="footer" class="footer shadow border-top">
    <div class="container text-dark">
        <div class="row gy-4 ">
            ...
            <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start ms-end">
                <h4>Contact Us</h4>
                <p>
                    Kantor Bupati Pamekasan<br />
                    Jl. Kabupaten No. 107<br />
                    Pamekasan<br /><br />
                    <strong>Phone:</strong> 0324 - 321331<br />
                    <strong>Email:</strong> yasirmaarif@gmail.com<br />
                </p>
            </div>
